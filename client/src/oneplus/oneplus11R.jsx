      ...
      <div className="i12-body">
        ...
        <div className="slider">
          ...
          <div className="images">
            ...
            <img src="./img/o11R-1.png" class="m1" alt="img1" checked></img>
            <img src="./img/o11R-2.png" class="m2" alt="img2" ></img>
            <img src="./img/o11R-1.png" class="m3" alt="img3" ></img>
            <img src="./img/o11R-2.png" class="m4" alt="img4" ></img>
          </div>
        ...
        <div className="item-price-box">
          <span className='white-txt'>ONEPLUS 11R</span> <br />
          <span className='item-price'>RS 10,000</span>
        ...
        <div className="a-section"><h3 className='a-heading'>Select Colour</h3><br />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="oneplus11r-sonic-black" />
              <label for="html" className='color-label'>Sonic Black</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="oneplus11r-galactic-silver" />
              <label for="html" className='color-label'>Galactic Silver</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="oneplus11r-solar-red" />
              <label for="html" className='color-label'>Solar Red</label>
            </div>
        ...
        <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="oneplus11R" />
        ...
        <div className="a-section"><h3 className='a-heading'>Product Details</h3>
          ...
          <div className="detail-box">
            ...
            <div className="detail-text">OnePlus 11R</div>
          </div>
          ...
          <div className="detail-box">
            ...
            <div className="detail-text">Galactic Silver</div>
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'>Whats in the Box?</h3><br />
          ...
          <span> Phone x 1 <br />
            Data cable x 1 (USB-A to USB Type-C) <br />
...
Welcome Letter x 1 </span>
        ...
        <div className="manufacture"><h3 className='manufacture-h'>Form the manufacturer</h3><br />
          ...
          <div className="pro-bg-box">
            <img src="./img/1+11r-bg1.jfif" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/1+11r-bg2.jfif" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/1+11r-bg3.jfif" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/1+11r-bg4.jfif" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/1+11r-bg5.jfif" alt="fail to load" />
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'>Feature & Details</h3>
          ...
          <ul className='desc-ul'>
            ...
            <li className='desc-li'>Operating System: OxygenOS based on Android 13 Processor: Snapdragon 8 Gen 1 Mobile Platform
