...
function Oneplus11R() {
  ...
  return (
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/o11R-1.png" class="m1" alt="img1"></img>
      ...
      <div className="item-price-box">
        <span className='white-txt'>One Plus 11R</span> <br />
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          <li className='desc-li'> Display : 6.74 inches (17.12 cm), AMOLED, 120 Hz Refresh Rate​ </li>
          <li className='desc-li'> Processor : Qualcomm Snapdragon 8 Gen 1</li>
          <li className='desc-li'> Camera : 50 MP + 8 MP + 2 MP Triple Rear & 16 MP Front Camera​​</li>
    ...
    <input type="radio" id="html" {...register("storage")} value="oneplus11R-256gb" />
    <label for="128gb" className='storage-label'>12+256GB</label>
    </li>

    
    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="oneplus11R-128gb" />
