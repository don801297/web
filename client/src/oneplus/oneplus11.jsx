...
function Oneplus11() {
  ...
  return (
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/o11-1.png" class="m1" alt="img1"></img>
      ...
      <div className="item-price-box">
        <span className='white-txt'>One Plus 11</span> <br />
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          <li className='desc-li'> Display : 6.7 inches (17.02 cm), AMOLED, 120 Hz Refresh Rate​</li>
          <li className='desc-li'> Processor : Qualcomm Snapdragon 8 Gen 2</li>
          <li className='desc-li'> Camera : 50 MP + 48 MP + 32 MP Triple Rear & 16 MP Front Camera​</li>
          <li className='desc-li'> Battery : 5000 mAh with 100W SUPERVOOC</li>
    ...
    <input type="radio" id="html" {...register("storage")} value="oneplus11-256gb" />
    <label for="128gb" className='storage-label'>12+256GB</label>
    </li>

    
    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="oneplus11-128gb" />
  ...
  <div className="desc-box">
    ...
    <li className='desc-li storage-li color-li'>
    <input type="radio" id="html" {...register("color")} value="marbel-odyssey" />
    <label for="html" className='color-label'>MARBLE ODYSSEY</label>
    </li>
