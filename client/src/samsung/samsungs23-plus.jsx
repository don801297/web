    ...
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/s23-plus-1.png" class="m1" alt="img1"></img>
          <img src="./img/s23-plus-2.png" class="m2" alt="img2"></img>
          <img src="./img/s23-plus-1.png" class="m3" alt="img3"></img>
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          <li className='desc-li'> Display: 6.6 inches (16.76 cm), Flat FHD+, 120 Hz Refresh Rate</li>
          <li className='desc-li'> Processor: Qualcomm Snapdragon 8 Gen 2, Octa-Core</li>
          <li className='desc-li'> Camera: 50MP + 10MP + 12MP Triple Rear & 12MP Front Camera</li>
          <li className='desc-li'>Battery: 4700mAh with 45W Fast Charging</li>
