...
function Zfold() {
  ...
  return (
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/zfold-1.png" class="m1" alt="img1"></img>
      ...
      <div className="item-price-box">
        <span className='white-txt'>Samsung Galaxy ZFold4</span> <br />
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          <li className='desc-li'> Display: 7.6 inches (19.3 cm), AMOLED 120 Hz Refresh Rate</li>
          <li className='desc-li'> Processor: Qualcomm Snapdragon 8+, Octa Core, 3.18 GHz</li>
          <li className='desc-li'> Camera: (50 MP + 12 MP + 10 MP) Rear & (10 MP + 4 MP) Front Camera</li>
          <li className='desc-li'> Battery: 3700 mAh with Quick Charging</li>
    ...
    <input type="radio" id="html" {...register("storage")} value="Zfold-256gb" />
    <label for="128gb" className='storage-label'>12+256GB</label>
    </li>

    
    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="Zfold-512gb" />
  ...
  <div className="desc-box">
    ...
    <li className='desc-li storage-li color-li'>
    <input type="radio" id="html" {...register("color")} value="soace-black" />
