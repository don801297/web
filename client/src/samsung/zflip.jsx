      ...
      <div className="i12-body">
        ...
        <div className="slider">
          ...
          <div className="images">
            ...
            <img src="./img/zflip-1.png" class="m1" alt="img1" checked></img>
        ...
        <div className="item-price-box">
          <span className='white-txt'>SAMSUNG GAZLAXY ZFLIP 3</span> <br />
        ...
        <div className="a-section"><h3 className='a-heading'>Select Colour</h3><br />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="samsung-zflip3-phantom-black" />
              <label for="html" className='color-label'>Phantom Black</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="samsung-zflip3-Gray" />
              <label for="html" className='color-label'>Gray</label>
            </div>
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="samsung-zflip3-lavender" />
              <label for="html" className='color-label'>Lavender</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="samsung-zflip3-cream" />
        ...
        <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="samsung-zflip-3" />
        ...
        <div className="a-section"><h3 className='a-heading'>Product Details</h3>
          ...
          <div className="detail-box">
            ...
            <div className="detail-text">ZFlip 3</div>
          </div>
          ...
          <div className="detail-box">
            ...
            <div className="detail-text">Creame</div>
          </div>
        ...
        <div className="manufacture"><h3 className='manufacture-h'>Form the manufacturer</h3><br />
          ...
          <div className="pro-bg-box">
            <img src="./img/zflip-bg1.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/zflip-bg2.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/zflip-bg3.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/zflip-bg4.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/zflip-bg5.jpg" alt="fail to load" />
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'>Feature & Details</h3>
          ...
          <ul className='desc-ul'>
            <li className='desc-li'> 8 GB RAM | 256 GB ROM </li>

            <li className='desc-li'> 17.02 cm (6.7 inch) Full HD+ Display</li>

            <li className='desc-li'>12MP + 12MP | 10MP Front Camera</li>

            <li className='desc-li'>	3300 mAh Lithium-ion Battery</li>

            <li className='desc-li'>Qualcomm Snapdragon 888 Octa-Core Processor </li>
