...
function Iphone11() {
  ...
  return (
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/i11-1.jpg" class="m1" alt="img1"></img>
      ...
      <div className="item-price-box">
        <span className='white-txt'>IPHONE 11</span> <br />
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          ...
          <li className='desc-li'> Processor: Apple A13 Bionic, Hexa Core</li>
          <li className='desc-li'> Camera: 12 MP + 12 MP Dual Rear &amp; 12 MP Front Camera</li>
          <li className='desc-li'>Battery: 3110 mAh </li>
          <li className='desc-li'>Security (Lock): Password | Pattern | Face ID Sensor </li>
        </ul>
    ...
    <input type="radio" id="html" {...register("storage")} value="iphone-11-64gb" />
    <label for="64gb" className='storage-label'>64GB</label>
    </li>

    
    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-11-128gb" />
