            ...
            <div className="i12-body">
                ...
                <div className="slider">
                    ...
                    <div className="images">
                        ...
                        <img src="./img/i16-3.png" class="m1" alt="img1" checked></img>
                        <img src="./img/i16-2.png" class="m2" alt="img2" ></img>
                        <img src="./img/i16-4.png" class="m3" alt="img3" ></img>
                        <img src="./img/i16-1.png" class="m4" alt="img4" ></img>
                    </div>
                ...
                <div className="item-price-box">
                    <span className='white-txt'>IPHONE 16 PLUS</span> <br />
                ...
                <div className="a-section"><h3 className='a-heading'>Select Colour</h3><br />
                    ...
                    <div className="color-box1">
                        ...
                        <div className="color">
                            <input type="radio" id="html" {...register("color")} value="iphone16plus-ultramarin" />
                            <label for="html" className='color-label'>Ultramarine</label>
                        </div>

                        <div className="color">
                            <input type="radio" id="html" {...register("color")} value="iphone16plus-teal" />
                    ...
                    <div className="color-box1">
                        ...
                        <div className="color">
                            <input type="radio" id="html" {...register("color")} value="iphone16plus-black" />
                            <label for="html" className='color-label'>Black </label>
                        </div>
                        <div className="color">
                            <input type="radio" id="html" {...register("color")} value="iphone16plus-Pink" />
                            <label for="html" className='color-label'>Pink</label>
                        </div>
                        <div className="color">
                            <input type="radio" id="html" {...register("color")} value="iphone16plus-white" />
                ...
                <div className="a-section"><h3 className='a-heading'>Product Details</h3>
                    ...
                    <div className="detail-box">
                        ...
                        <div className="detail-text">2048 x 1536</div>
                    </div>

                    <div className="detail-box">
                        <div className="details-bold"> Model Name</div>
                        <div className="detail-text">iPhone 16 Plus</div>
                    </div>
                ...
                <div className="a-section"><h3 className='a-heading'>Whats in the Box?</h3><br />
                    ...
                    <span>* iPhone 16 Plus with iOS 17,  USB-Cable</span>
                ...
                <div className="a-section"><h3 className='a-heading'> Description</h3>
                    ...
                    <div className="service-box">
                        ...
                        <div className="description-pp">iPhone 16 Plus. Built for Apple Intelligence. Featuring Camera 
                            Control. 48MP Fusion camera. Five vibrant colours. And A18 chip..</div>
                    </div>
                ...
                <div className="a-section"><h3 className='a-heading'>Feature & Details</h3>
                    ...
                    <ul className='desc-ul'>
                        ...
                        <li className='desc-li'> GET FURTHER AND CLOSER — The improved Ultra Wide camera
                             with autofocus lets you take incredibly detailed macro photos and videos. Use the 48MP Fusion camera 
                            for stunning high-resolution images, and zoom in with the 2x optical-quality Telephoto.</li>


                        <li className='desc-li'>PHOTOGRAPHIC STYLES — The latest-generation Photographic
                             Styles give you greater creative flexibility, so you can make
                             every photo even more you. And you can reverse any of those styles anytime you want. </li>


                        <li className='desc-li'>SUPER-SMART A18 CHIP — A18 jumps two generations ahead of
                             the A16 Bionic chip in iPhone 15. It enables Apple Intelligence, powers advanced photo
                             and video features, and supports console-level gaming, with exceptional power efficiency.</li>


                             <li className='desc-li'>LONGER BATTERY LIFE — iPhone 16 Plus works together with the 
                                A18 chip to deliver a big boost in battery life with up to 22 hours video playback.
                                 Charge via USB-C or snap on a MagSafe charger for faster wireless charging.</li>

                             <li className='desc-li'>DESIGNED TO LAST — iPhone 16 Plus has a sturdy, aerospace-grade aluminium design with a 15.54 cm (6.1″) Super Retina XDR display. It’s remarkably durable with the 
                                latest-generation Ceramic Shield material that’s 2x tougher than any smartphone glass.</li>

                             <li className='desc-li'>CUSTOMISE YOUR IPHONE — With iOS 18, you can tint your Home Screen
                                 icons with any colour. Find your favourite shots faster in the redesigned Photos app. And add
