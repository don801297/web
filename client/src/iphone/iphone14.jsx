...
function Iphone14() {
  ...
  return (
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/i14-1.png" class="m1" alt="img1"></img>
      ...
      <div className="item-price-box">
        <span className='white-txt'>IPHONE 14</span> <br />
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          <li className='desc-li'> Display: 6.1 inches (15.40 cm) OLED Display</li>
    ...
    <input type="radio" id="html" {...register("storage")} value="iphone-14-128gb" />
    <label for="128gb" className='storage-label'>128GB</label>
    </li>

    
    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-14-256gb" />
    <label for="128gb" className='storage-label'>256GB</label>
    </li>

    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-14-512gb" />
