      ...
      <div className="i12-body">
        ...
        <div className="slider">
          ...
          <div className="images">
            ...
            <img src="./img/i14-pro-3.png" class="m1" alt="img1" checked></img>
            <img src="./img/i14-pro-4.jpg" class="m2" alt="img2" ></img>
            <img src="./img/i14-pro-1.png" class="m3" alt="img3" ></img>
            <img src="./img/i14-pro-2.jpg" class="m4" alt="img4" ></img>
          </div>
        ...
        <div className="item-price-box">
          <span className='white-txt'> IPHONE 14 PRO MAX</span> <br />
        ...
        <div className="a-section"><h3 className='a-heading'>Select Colour</h3><br />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14promax-Gold" />
              <label for="html" className='color-label'>Gold</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14promax-Space-black" />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14promax-silver" />
              <label for="html" className='color-label'>Silver</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14promax-Deep-purple" />
        ...
        <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="Iphone14promax" />
        ...
        <div className="a-section"><h3 className='a-heading'>Product Details</h3>
          ...
          <div className="detail-box">
            ...
            <div className="detail-text">5 GHz</div>
          </div>
          ...
          <div className="detail-box">
            ...
            <div className="detail-text">Space Black</div>
          </div>
        ...
        <div className="manufacture"><h3 className='manufacture-h'>Form the manufacturer</h3><br />
          ...
          <div className="pro-bg-box">
            <img src="./img/i14-probg-1.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/i14-probg2.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/i14-probg3.jpg" alt="fail to load" />
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'> Description</h3>
          ...
          <div className="service-box">
            ...
            <div className="description-pp">iPhone 14 Pro Max. Capture incredible detail with a 48MP Main camera. Experience iPhone in a whole new way with Dynamic Island and Always-On 
              display. Crash Detection, a new safety feature, calls for help when you can’t.</div>
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'>Feature & Details</h3>
          ...
          <ul className='desc-ul'>
            <li className='desc-li'> 17.00 cm (6.7-inch) Super Retina XDR display featuring Always-On and pro motion</li>
            <li className='desc-li'> Dynamic Island, a magical new way to interact with iPhone</li>
            <li className='desc-li'> 48MP Main camera for up to 4x greater resolution</li>
            ...
            <li className='desc-li'> A16 Bionic chip with 5-core GPU for lightning-fast performance. Superfast 5G cellular</li>
