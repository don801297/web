...
function Iphone15pro() {
  ...
  return (
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/i15-pro-4.png" class="m1" alt="img1"></img>
          <img src="./img/i15-pro-3.png" class="m2" alt="img2"></img>
          <img src="./img/i15-pro-1.png" class="m3" alt="img3"></img>
          <img src="./img/i15-pro-2.png" class="m4" alt="img4"></img>
        </div>
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          <li className='desc-li'> Display: 6.1 inches, Super Retina XDR Display, 120 Hz Refresh Rate</li>
    ...
    <input type="radio" id="html" {...register("storage")} value="iphone-15pro-128gb" />
    <label for="128gb" className='storage-label'>128GB</label>
    </li>

    
    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-15pro-256gb" />
    <label for="128gb" className='storage-label'>256GB</label>
    </li>

    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-15pro-512gb" />
    <label for="64gb" className='storage-label'>512GB</label>
    </li>

    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-15pro-1tb" />
