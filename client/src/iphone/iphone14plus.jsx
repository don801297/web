      ...
      <div className="i12-body">
        ...
        <div className="slider">
          ...
          <div className="images">
            ...
            <img src="./img/i14-2.jpg" class="m3" alt="img3" ></img>
        ...
        <div className="a-section"><h3 className='a-heading'>Select Colour</h3><br />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14Plus-Starlight" />
              <label for="html" className='color-label'>Starlight </label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14Plus-midnight" />
              <label for="html" className='color-label'>Midnight</label>
            </div>


            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14Plus-Purple" />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14Plus-red" />
              <label for="html" className='color-label'>Red</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14Plus-Blue" />
              <label for="html" className='color-label'>Blue</label>
            </div>

            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14Plus-Yellow" />
        ...
        <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="Iphone14plus" />
        ...
        <div className="a-section"><h3 className='a-heading'>Product Details</h3>
          ...
          <div className="detail-box">
            ...
            <div className="detail-text">Midnight</div>
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'> Description</h3>
          ...
          <div className="service-box">
            ...
            <div className="description-pp">iPhone 14 Plus. Think big with a larger 16.95-centimetre (6.7-inch) display and all-day battery life. Capture stunning photos in low light and bright light with the new dual-camera system.
               Crash Detection, a new safety feature, calls for help when you can’t.</div>
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'>Feature & Details</h3>
          ...
          <ul className='desc-ul'>
            <li className='desc-li'> 16.95 cm (6.7-inch) Super Retina XDR display</li>
