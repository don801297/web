      ...
      <div className="i12-body">
        ...
        <div className="slider">
          ...
          <div className="images">
            ...
            <img src="./img/i13-1.jpg" class="m1" alt="img1" checked></img>
        ...
        <div className="item-price-box">
          <span className='white-txt'> IPHONE 13 MINI</span> <br />
        ...
        <div className="a-section"><h3 className='a-heading'>Select Colour</h3><br />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone13mini-Starlight" />
              <label for="html" className='color-label'>Starlight </label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone13mini-midnight" />
              <label for="html" className='color-label'>Midnight</label>
            </div>


            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone13mini-pink" />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone13mini-red" />
              <label for="html" className='color-label'>Red</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone13mini-Blue" />
              <label for="html" className='color-label'>Blue</label>
            </div>

            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone13mini-green" />
        ...
        <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="Iphone13mini" />
        ...
        <div className="a-section"><h3 className='a-heading'>Feature & Details</h3>
          ...
          <ul className='desc-ul'>
            <li className='desc-li'> (5.4-inch) Super Retina XDR display</li>
