...
function Iphone13mini() {
  ...
  return (
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/i13-4.jpg" class="m1" alt="img1"></img>
          <img src="./img/i13-3.jpg" class="m2" alt="img2"></img>
          <img src="./img/i13-2.jpg" class="m3" alt="img3"></img>
          <img src="./img/i13-1.jpg" class="m4" alt="img4"></img>
        </div>
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          <li className='desc-li'> Display: 5.4 inches (13.72 cm), Super Retina XDR OLED</li>
          ...
          <li className='desc-li'>Security (Lock): Password | PIN | Fingerprint Sensor | Face Unlock </li>
        </ul>
    ...
    <input type="radio" id="html" {...register("storage")} value="iphone-13mini-128gb" />
    <label for="128gb" className='storage-label'>128GB</label>
    </li>

    
    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-13mini-256gb" />
    <label for="128gb" className='storage-label'>256GB</label>
    </li>

    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-13mini-512gb" />
