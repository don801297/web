...
function Iphone15plus() {
  ...
  return (
    <>
      ...
      <div className="slider">
        ...
        <div className="images">
          ...
          <img src="./img/i15-4.png" class="m1" alt="img1"></img>
          <img src="./img/i15-3.png" class="m2" alt="img2"></img>
          <img src="./img/i15-1.png" class="m3" alt="img3"></img>
          <img src="./img/i15-2.png" class="m4" alt="img4"></img>
        </div>
      ...
      <div className="desc-box">
        ...
        <ul className='desc-ul'>
          <li className='desc-li'> Display: 6.7 inches (15.54 cm), Super Retina XDR Display</li>
          <li className='desc-li'> Processor: Apple A16 Bionic Chip, Hexa Core</li>
          <li className='desc-li'> Camera: 48 MP + 12 MP Dual Rear & 12 MP Front Camera</li>
          <li className='desc-li'>Battery: 15W MagSafe Wireless Charging </li>
          <li className='desc-li'>USP: Dynamic Island, IP68 Water Resistant </li>
        </ul>
    ...
    <input type="radio" id="html" {...register("storage")} value="iphone-15plus-128gb" />
    <label for="128gb" className='storage-label'>128GB</label>
    </li>

    
    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-15plus-256gb" />
    <label for="128gb" className='storage-label'>256GB</label>
    </li>

    <li className='desc-li storage-li'>
    <input type="radio" id="html" {...register("storage")} value="iphone-15plus-512gb" />
