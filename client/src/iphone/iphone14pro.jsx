      ...
      <div className="i12-body">
        ...
        <div className="slider">
          ...
          <div className="images">
            ...
            <img src="./img/i14-pro-1.png" class="m1" alt="img1" checked></img>
        ...
        <div className="a-section"><h3 className='a-heading'>Select Colour</h3><br />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14pro-Gold" />
              <label for="html" className='color-label'>Gold</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14pro-Space-black" />
          ...
          <div className="color-box1">
            ...
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14pro-silver" />
              <label for="html" className='color-label'>Silver</label>
            </div>
            <div className="color">
              <input type="radio" id="html" {...register("color")} value="iphone14pro-Deep-purple" />
        ...
        <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="Iphone14pro" />
