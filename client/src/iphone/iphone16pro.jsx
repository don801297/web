            ...
            <div className="i12-body">
                ...
                <div className="slider">
                    ...
                    <div className="images">
                        ...
                        <img src="./img/i16-pro-1.png" class="m1" alt="img1" checked></img>
                        <img src="./img/i16-pro-2.png" class="m2" alt="img2" ></img>
                ...
                <div className="item-price-box">
                    <span className='white-txt'>IPHONE 16 PRO</span> <br />
                ...
                <div className="a-section"><h3 className='a-heading'>Product Details</h3>
                    ...
                    <div className="detail-box">
                        ...
                        <div className="detail-text">6.3 Inches</div>
                    </div>
                    ...
                    <div className="detail-box">
                        ...
                        <div className="detail-text">iPhone 16 Pro</div>
                    </div>
                ...
                <div className="a-section"><h3 className='a-heading'>Whats in the Box?</h3><br />
                    ...
                    <span>* iPhone 16 Pro with  USB-Cable</span>
                ...
                <div className="a-section"><h3 className='a-heading'> Description</h3>
                    ...
                    <div className="service-box">
                        ...
                        <div className="description-pp">iPhone 16 Pro. Built for Apple Intelligence. Featuring a stunning
                ...
                <div className="a-section"><h3 className='a-heading'>Feature & Details</h3>
                    ...
                    <ul className='desc-ul'>
                        <li className='desc-li'> STUNNING TITANIUM DESIGN — iPhone 16 Pro has a strong and light titanium design with a larger 15.93 cm (6.3″) Super Retina XDR display. It’s remarkably durable with the 
                        ...
                        <li className='desc-li'>TAKE TOTAL CAMERA CONTROL — Camera Control gives you an easier way to quickly access
                             camera tools, like zoom or depth of field, so you can take the perfect shot in record time..</li>


                        <li className='desc-li'>MAGNIFICENT SHOTS — Take your videos to a whole new level with 4K 120 fps Dolby Vision, enabled by the 48MP Fusion camera. The improved
                             48MP Ultra Wide camera lets you capture mesmerising detail in macro photos and wide-angle shots. </li>


                        <li className='desc-li'>PHOTOGRAPHIC STYLES — The latest-generation Photographic Styles give you greater creative flexibility, so you can make every photo even more you. And thanks to
