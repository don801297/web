      ...
      <div className="i12-body">
        ...
        <div className="slider">
          ...
          <div className="images">
            ...
            <img src="./img/mi-watch1.jpg" class="m1" alt="img1" checked></img>
            <img src="./img/mi-watch2.jpg" class="m2" alt="img2" ></img>
            <img src="./img/mi-watch3.jpg" class="m3" alt="img3" ></img>
            <img src="./img/mi-watch4.jpg" class="m4" alt="img4" ></img>
          </div>
        ...
        <div className="item-price-box">
          <span className='white-txt'>MI Smart Watch</span> <br />
          <span className='item-price'>RS 449</span>
        ...
        <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="mi-watch" />
        ...
        <div className="a-section"><h3 className='a-heading'>Product Details</h3>
          ...
          <div className="detail-box">
            ...
            <div className="detail-text">MI</div>
          </div>
          ...
          <div className="detail-box">
            <div className="details-bold"> Band Material</div>
            <div className="detail-text">Silicone</div>
          </div>

          <div className="detail-box">
            <div className="details-bold"> Battery Time</div>
            <div className="detail-text">60 minutes</div>
          </div>

          <div className="detail-box">
            <div className="details-bold"> Memory</div>
            <div className="detail-text">512 MB</div>
          </div>

          <div className="detail-box">
            <div className="details-bold"> Item Weight </div>
            <div className="detail-text">99 gram</div>
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'>Whats in the Box?</h3><br />
          ...
          <span>Mi Smart Watch Bill/card</span>
        ...
        <div className="manufacture"><h3 className='manufacture-h'>Form the manufacturer</h3><br />
          ...
          <div className="pro-bg-box">
            <img src="./img/mi-watch5.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/mi-watch6.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/mi-watch7.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/mi-watch8.jpg" alt="fail to load" />
          </div>
          <div className="pro-bg-box">
            <img src="./img/mi-watch4.jpg" alt="fail to load" />
          </div>
        ...
        <div className="a-section"><h3 className='a-heading'> Description</h3>
          ...
          <div className="service-box">
            ...
            <div className="description-pp">ID116 Bluetoth Wireless Smart Watch Fitness Band for Boys, Girls, Men, Women
                 & Kids | Sports Watch for All Smart Phones I Heart Rate and BP Monitor.</div>
          </div>
