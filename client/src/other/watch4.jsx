            ...
            <div className="i12-body">
                ...
                <div className="slider">
                    ...
                    <div className="images">
                        ...
                        <img src="./img/watch4-1.webp" class="m1" alt="img1" checked></img>
                        <img src="./img/watch4-2.webp" class="m2" alt="img2" ></img>
                        <img src="./img/watch4-3.webp" class="m3" alt="img3" ></img>
                        <img src="./img/watch4-1.webp" class="m4" alt="img4" ></img>
                    </div>
                ...
                <div className="item-price-box">
                    <span className='white-txt'>RPS Digital Watch</span> <br />
                    <span className='item-price'>RS 120</span>
                ...
                <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="rps-watch" />
                ...
                <div className="a-section"><h3 className='a-heading'>Product Details</h3>
                    ...
                    <div className="detail-box">
                        ...
                        <div className="detail-text">RPS</div>
                    </div>
                    ...
                    <div className="detail-box">
                        ...
                        <div className="detail-text">2 Month</div>
                    </div>
                    ...
                    <div className="detail-box">
                        ...
                        <div className="detail-text">0.8 g</div>
                    </div>
                ...
                <div className="manufacture"><h3 className='manufacture-h'>Form the manufacturer</h3><br />
                    ...
                    <div className="pro-bg-box">
                        <img src="./img/watch4-1.webp" alt="fail to load" />
                    </div>
                    <div className="pro-bg-box">
                        <img src="./img/watch4-2.webp" alt="fail to load" />
                    </div>
                    <div className="pro-bg-box">
                        <img src="./img/watch4-3.webp" alt="fail to load" />
                    </div>
...
<div className="service-box">
  ...
  <div className="description-pp">Water Resistant | Note - please Do Not press any buttons in the water <br />
Dimensions - Case Diameter -55mm | Case Width - 54mm | Case Thickness - 17mm | Band Width - <br />
22mm | Max Perimeter - 240mm | Min Perimeter - 170mm <br />
RPS FASHION WITH DEVICE OF R Digital Wtches <br />
Warranty Type: Manufacturer; Item Shape: Round; Band Material Type: Silicone; Case Material Type: Rubber; Bezel Function: Gmt; Watch Movement Type: Automatic; Dial Color: Red</div>
</div>
