            ...
            <div className="i12-body">
                ...
                <div className="slider">
                    ...
                    <div className="images">
                        ...
                        <img src="./img/data-cable1-1.webp" class="m1" alt="img1" checked></img>
                        <img src="./img/data-cable1-2.webp" class="m2" alt="img2" ></img>
                        <img src="./img/data-cable1-3.webp" class="m3" alt="img3" ></img>
                        <img src="./img/data-cable1-1.webp" class="m4" alt="img4" ></img>
                    </div>
                ...
                <div className="item-price-box">
                    <span className='white-txt'>pTron USB Type-C cable</span> <br />
                ...
                <input type="text"      {...register("ahn")} name='ahn' className="backend-product-name" value="ptron-cable" />
                ...
                <div className="a-section"><h3 className='a-heading'>Product Details</h3>
                    ...
                    <div className="detail-box">
                        ...
                        <div className="detail-text">pTron</div>
                    </div>
                    ...
                    <div className="detail-box">
                        <div className="details-bold"> Cable Type</div>
                        <div className="detail-text">USB</div>
                    </div>
                    <div className="detail-box">
                        <div className="details-bold"> Specification Met</div>
                        <div className="detail-text">Type C</div>
                    </div>

                    <div className="detail-box">
                        <div className="details-bold"> Manufacturer</div>
                        <div className="detail-text">in India</div>
                    </div>

                    <div className="detail-box">
                        <div className="details-bold"> weight </div>
                        <div className="detail-text">30 g</div>
                    </div>
                ...
                <div className="a-section"><h3 className='a-heading'>Whats in the Box?</h3><br />
                    ...
                    <span>pTron USB type-c Cable</span>
                ...
                <div className="manufacture"><h3 className='manufacture-h'>Form the manufacturer</h3><br />
                    ...
                    <div className="pro-bg-box">
                        <img src="./img/data-cable1-1.webp" alt="fail to load" />
                    </div>
                    <div className="pro-bg-box">
                        <img src="./img/data-cable1-2.webp" alt="fail to load" />
                    </div>
                    <div className="pro-bg-box">
                        <img src="./img/data-cable1-3.webp" alt="fail to load" />
                    </div>
...
<div className="service-box">
  ...
  <div className="description-pp">Solero T241 data and charging cable is equipped with a Type-C USB port, the cable supports up to 2.4Amps of power output for powering and fast charging your smart device. <br />
Charge & sync, this USB cable can charge and data sync simultaneously at 480Mbps speed, compatible with all devices with a C-Type USB port. <br />
Durable PVC Outer Exterior: PVC cables are versatile, high in tensile strength, flexible, and good conductors.</div>
</div>
